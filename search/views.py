...
def search(request):
    ...
    if request.method == 'POST':
        if searchform.is_valid():
            ...
            if request.user.is_authenticated:
                ...
                return render(request, 'search.html',
                              {'searchform': searchform, 'listform': listform, 'addPlayListForm': addPlayListForm,
        ...
        if request.user.is_authenticated:
            ...
            listform.fields['Playlist'].queryset = playlists
            return render(request, 'search.html',
                          {'searchform': searchform, 'listform': listform, 'playlists': playlists,
...
def search_songs(query):
    sp = spotipy.Spotify(
        client_credentials_manager=SpotifyClientCredentials(client_id='616f55f94a904037a1eb6bdfbfa96d95',
                                                            client_secret='2e262cfa37904ebeb74d43ff6903c9de'))
